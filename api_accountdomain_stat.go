 ...
 * @param domainId the domainName you want to get
...
func (a *AccountdomainStatApiService) DomainStatRouterGetAllAggregateDomainStatsByGroup(ctx context.Context, xAccountApiKey string, domainId int64, provider string, localVarOptionals *AccountdomainStatApiDomainStatRouterGetAllAggregateDomainStatsByGroupOpts) (ModelsStat, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/account/domainStat/{domainId}/aggregate/provider"
...
func (a *AccountdomainStatApiService) DomainStatRouterGetStatsForASingleDomainStats(ctx context.Context, xAccountApiKey string, domainId string, localVarOptionals *AccountdomainStatApiDomainStatRouterGetStatsForASingleDomainStatsOpts) (ModelsStat, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/account/domainStat/{domainId}/aggregate"
	localVarPath = strings.Replace(localVarPath, "{"+"domainId"+"}", fmt.Sprintf("%v", domainId), -1)
